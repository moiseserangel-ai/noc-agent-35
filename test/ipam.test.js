...
import { addressInSubnet, cidrsOverlap, normalizeSubnet, parseCidr } from '../src/services/ipam.service.js';
...
test('detecta redes IPAM sobrepostas',()=>{assert.equal(cidrsOverlap('192.168.10.0/24','192.168.10.128/25'),true);assert.equal(cidrsOverlap('192.168.10.0/24','192.168.11.0/24'),false);});
