...
const NAV_ITEMS = [
  ...
  { path: '/commercial-dashboard', label: 'Visão comercial', icon: LayoutDashboard, roles: ['admin'] },
  ...
  { path: '/commercial-expiries', label: 'Vencimentos e renovações', icon: CalendarClock, roles: ['admin'] },
