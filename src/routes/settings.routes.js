...
const SENSITIVE_KEYS = ['claude_api_key', 'openai_api_key', 'gemini_api_key', 'evolution_api_key', 'telegram_bot_token', 'zabbix_webhook_token', 'zabbix_api_token', 'nvd_api_key', 'netbox_api_token', 'dashboard_password', 'encryption_key'];
